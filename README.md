# MODEL1310110004: MODEL1310110004
...
`pip install git+https://github.com/biomodels/MODEL1310110004.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110004.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110004 as model`
...
The model of uterus post menopause glandular cells metabolism is derived from
the community-driven global reconstruction of human metabolism (version 2.02,
...
and identified by:
[MODEL1310110004](http://identifiers.org/biomodels.db/MODEL1310110004) .
